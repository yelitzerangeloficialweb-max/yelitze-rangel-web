        ...
        <section className="py-16 md:py-32 bg-white relative z-30">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    {/* Text Content - Now first on Desktop */}
                    <motion.div
                        initial={{ opacity: 0, x: -30 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="w-full lg:flex-1 space-y-8 text-center lg:text-left order-2 lg:order-1"
                    >
                    ...
                    {/* Portrait Image Content - Now second on Desktop */}
                    <div className="w-full lg:flex-1 relative order-1 lg:order-2">
                        {/* Decorative squiggly line - moved to the right side */}
                        <div className="absolute top-1/2 right-0 -translate-y-1/2 -mr-12 w-48 h-48 opacity-20 pointer-events-none">
                            <svg viewBox="0 0 100 100" className="w-full h-full stroke-[#B8835A] fill-none stroke-[0.5] rotate-180">
                                <path d="M0,50 C20,20 80,80 100,50 S180,20 200,50" />
                            </svg>
                        </div>

                        {/* Portrait Image with Two Pointy and Two Rounded Corners */}
                        <div className="relative z-10 w-full max-w-[550px] aspect-[4/5] rounded-tr-[160px] rounded-bl-[160px] overflow-hidden shadow-[0_40px_80px_-15px_rgba(0,0,0,0.15)] mx-auto lg:mr-0">
                            <Image
