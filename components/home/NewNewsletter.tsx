                ...
                >
                    ...
                    <form className="flex flex-col md:flex-row items-center justify-center gap-4 bg-white/10 p-2 rounded-full backdrop-blur-md border border-white/20">
                        <input
                            ...
                            className="flex-grow bg-transparent border-none px-8 py-4 text-white placeholder:text-white/50 focus:outline-none focus:ring-0 w-full"
                        />
                        <button
                            type="submit"
                            className="btn-premium whitespace-nowrap px-10 py-4 bg-accent text-background hover:bg-accent-light"
                        >
                            Suscribirme
                        </button>
                    </form>
