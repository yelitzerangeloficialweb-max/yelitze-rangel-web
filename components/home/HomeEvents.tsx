                            ...
                            >
                                <div className="group h-full bg-stone-50/50 rounded-[3rem] overflow-hidden border border-stone-100 flex flex-col transition-all duration-700 hover:shadow-2xl hover:bg-white hover:-translate-y-2">
                                    ...
                                    <div className="relative h-72 overflow-hidden">
                                        ...
                                        />
                                        <div className="absolute top-6 right-6 bg-white/90 backdrop-blur-md px-5 py-2 rounded-full text-[10px] font-bold font-body tracking-[0.2em] uppercase text-primary shadow-sm">
                                            {event.type}
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-10 flex flex-col flex-grow">
                                        ...
                                        <h3 className="text-2xl font-heading text-primary mb-4 italic leading-tight group-hover:text-secondary transition-colors">
                                            {event.title}
                                        </h3>
                                        ...
                                        <div className="mt-auto pt-8 border-t border-stone-100 flex items-center justify-between">
                                            ...
                                            <div className="w-10 h-10 rounded-full bg-white border border-stone-100 flex items-center justify-center group-hover:bg-secondary group-hover:text-white transition-all duration-500 shadow-sm">
