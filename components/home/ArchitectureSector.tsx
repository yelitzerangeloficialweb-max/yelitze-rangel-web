                ...
                <div className="flex flex-col lg:flex-row items-center justify-end">
                    ...
                    >
                        <div className="space-y-2">
                            <span className="text-[10px] md:text-xs font-bold tracking-[0.4em] text-black/50 uppercase">
                            ...
                            <div className="space-y-0">
                                ...
                                <h3 className="text-4xl md:text-6xl lg:text-[4.5rem] font-medium text-black leading-tight">
                                    Intencional
                                </h3>
                            </div>
                        </div>

                        <p className="text-lg md:text-xl text-black/80 font-body font-light leading-relaxed max-w-xl mx-auto lg:mx-0">
