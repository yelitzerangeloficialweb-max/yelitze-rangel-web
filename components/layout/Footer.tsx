        ...
        <footer className="bg-[var(--color-text)] text-white py-16 border-t border-white/10">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    {/* Links 1 */}
                    <div>
                        <h4 className="text-lg font-heading mb-6 text-[var(--color-accent)]">Explora</h4>
                    ...
                    {/* Links 2 */}
                    <div>
                        <h4 className="text-lg font-heading mb-6 text-[var(--color-accent)]">Legal</h4>
                        <ul className="space-y-3 text-white/70 text-sm">
                    ...
                    {/* Newsletter */}
                    <div>
                        <h4 className="text-lg font-heading mb-6 text-[var(--color-accent)]">Únete a la Comunidad</h4>
