                ...
                <div className="bg-[#FAF9F6] relative rounded-sm shadow-2xl overflow-hidden min-h-[600px]">
                    ...
                    <div className="p-8 md:p-16 pt-20">
                        ...
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xs text-gray-400">Creencias sobre el Dinero</p>
                            <div className="w-12 h-0.5 bg-[var(--color-secondary)] mx-auto opacity-50 mt-2"></div>
                        </div>
                        ...
                        {resultData.mantra && (
                            <div className="relative py-12 px-8 text-center mt-12 mb-8">
                                ...
                                <div className="border-t border-b border-[var(--color-secondary)]/30 py-8">
                                    <h4 className="text-xs font-bold uppercase tracking-[0.4em] text-[var(--color-secondary)] mb-4">Tu Mantra de Abundancia</h4>
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="border-b-2 border-[#D4AF37]/20 pb-8 mb-12 flex justify-between items-center">
                            <div className="flex-1">
                                ...
                                <p className="text-xs uppercase tracking-[0.3em] text-[#D4AF37] font-bold mb-2">Creencias sobre el Dinero</p>
                        ...
                        {resultData.mantra && (
                            <div className="mt-12 p-8 bg-[#FAF9F6] border-l-4 border-[#D4AF37] text-center rounded-r-xl">
                                <p className="text-sm uppercase tracking-widest text-gray-400 mb-3">Mantra de Abundancia</p>
                        ...
                        <div className="mt-16 mb-8 text-center p-8 border border-dashed border-[#D4AF37]/50 rounded-xl bg-[#FFFBF0]">
                            <p className="text-lg text-[var(--color-primary)] font-medium mb-4">¿Te atreves a desbloquear tu abundancia?</p>
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-100 flex justify-between items-end">
                            <div>
                                <p className="text-xs text-gray-400 uppercase tracking-[0.2em] mb-1">Anatomía del Dinero</p>
                                <p className="text-[10px] text-gray-300">Guía espiritual · No sustituye asesoría financiera</p>
                            </div>
