...
export default function Portal4Step({ value, onChange, onNext, onBack }: Props) {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 bg-[#F5EFE6] rounded-[3rem] min-h-[80vh] flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="text-center mb-16 space-y-4">
                ...
                <p className="text-[#3C2A21] italic text-xl md:text-2xl font-editorial tracking-wide opacity-90">El mapa práctico para diseñar mi respuesta interna.</p>
            </div>
