                ...
                <div className="mt-20 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-[#3C2A21]/60 font-guide text-sm leading-relaxed max-w-2xl">
                            Nombra aquello que dejas aquí hoy. Al escribirlo, visualiza cómo recuperas ese poder para tu propia arquitectura y cómo esa energía se transforma en fuerza creativa.
                        </p>
                    </div>
