                ...
                <div className="mt-20 space-y-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-[#3C2A21]/60 font-guide text-sm leading-relaxed max-w-2xl">
                            Utiliza estos hallazgos para trazar tu nueva frontera de enfoque. Define con claridad qué áreas de tu vida requieren hoy una estructura de protección y soberanía.
                        </p>
                    </div>
