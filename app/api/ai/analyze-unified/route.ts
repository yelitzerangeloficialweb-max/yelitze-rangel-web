...
export async function POST(req: Request) {
    try {
        ...
        if (userInfo.email && userInfo.email.includes('@')) {
            try {
                console.log(`[Unified Test] Sending email to ${userInfo.email}...`);
                ...
                const pdfBuffer = await generateGenericTestPDF(userInfo.name || 'Explorador/a', 'Diagnóstico Ancestral Completo', parsedData.pdf_content);
                ...
                console.log(`[Unified Test] Email sent successfully`);
            } catch (mailError) {
