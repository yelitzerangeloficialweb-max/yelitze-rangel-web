...
`;
        ...
        if (targetEmail && targetEmail.includes('@')) {
            try {
                console.log(`[Dinero Test] Sending email to ${targetEmail}...`);
                ...
                const pdfBuffer = await generateGenericTestPDF(name || 'Familia de Almas', 'Relación con el Dinero', parsedResult.pdf_content);
                ...
                console.log(`[Dinero Test] Email sent successfully`);
            } catch (mailError) {
