...
`;
        ...
        if (userEmail && userEmail.includes('@')) {
            try {
                console.log(`[Amor Test Debug] Attempting email to: ${userEmail}, name: ${userName}`);
                ...
                const pdfBuffer = await generateGenericTestPDF(userName, 'Creencias sobre el Amor', pdfContent);
            ...
            console.warn(`[Amor Test Debug] Skipping email: invalid or missing email address: "${userEmail}"`);
        }
