...
`;
        ...
        if (body.email && body.email.includes('@')) {
            try {
                console.log(`[Heridas Test] Sending email to ${body.email}...`);
                ...
                const pdfBuffer = await generateGenericTestPDF(name || 'Familia de Almas', 'Heridas de la Infancia', parsedResult.pdf_content);
