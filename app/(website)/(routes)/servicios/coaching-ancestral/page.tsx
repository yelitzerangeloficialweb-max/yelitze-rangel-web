            ...
            <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
                ...
                <div className="container mx-auto px-8 lg:px-40 relative z-10 text-center">
                    <FadeIn>
                        ...
                        {/* Main Heading */}
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white uppercase tracking-tighter leading-none mb-8">
                            Anatomía del Alma
                        </h1>
                    ...
                    <StaggerContainer className="grid lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
                        ...
                        <StaggerItem className="group">
                            <div className="bg-[#1a1a1a] p-10 lg:p-14 rounded-3xl border-2 border-[var(--color-secondary)]/20 shadow-2xl relative overflow-hidden h-full flex flex-col">
                                ...
                                <h3 className="text-3xl font-heading text-white mb-2">Ceremonia Íntima Presencial · 1:1</h3>
                                <p className="text-[var(--color-secondary)] uppercase tracking-widest text-xs mb-4 font-bold italic">"Una experiencia ancestral creada solo para ti."</p>
                                ...
                                <ul className="space-y-4 flex-grow mb-8 font-light italic text-gray-400">
                                    {[
                                        "No es motivación: es entrenamiento energético.",
                                        "Sin fórmulas, sin exposición, sin ruido.",
                                        "La confidencialidad es absoluta.",
                                        "La transformación, real y silenciosa."
                                    ].map((text, i) => (
                                        <li key={i} className="flex items-center gap-3">
                                            <span className="w-1 h-1 bg-[var(--color-secondary)] rounded-full" />
                                ...
                                <div className="mt-auto pt-6 border-t border-white/5">
                                    ...
                                    >
                                        Contáctanos por WhatsApp para recibir información y reservar tu espacio
                                        <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
                                    </a>
                                </div>
                            </div>
