  ...
  return (
    <html lang="es" className={`${allison.variable} ${playfair.variable} ${inter.variable} ${cormorant.variable} ${montserrat.variable}`}>
      ...
      <body>
        ...
        {/* Left Side (Bottom of services / transition) - Smaller (40% less) */}
        <div className="absolute top-[330vh] left-[-12.5vw] w-[25vw] h-[25vw] bg-[radial-gradient(circle_at_center,rgba(233,123,50,1)_0%,rgba(233,123,50,0.85)_40%,rgba(233,123,50,0.3)_65%,transparent_85%)] blur-[60px] pointer-events-none z-[100]" />
