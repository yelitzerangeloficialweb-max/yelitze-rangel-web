...
export const BLOG_POSTS: BlogPost[] = [
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    Esa sensación de estar en un "bucle" infinito no es mala suerte, ni falta de voluntad. Es, en realidad, el resultado de un sistema operativo biológico y ancestral que se ejecuta en segundo plano. Nuestros patrones de comportamiento no son fallos de fábrica; son <strong>estrategias de supervivencia</strong> que un d├¡a aprendimos para pertenecer a nuestro sistema familiar. Sin embargo, lo que antes nos protegió del dolor o la exclusión, hoy puede ser la jaula que nos impide crecer.
                </p>

                <!-- INTERÉS: LA CIENCIA -->
                <h3 class="text-3xl font-heading text-[var(--color-primary)] mt-12 mb-6">La Ciencia de la Decisión: Tus Autopistas Mentales</h3>
                <p>
                    La neurociencia moderna nos ha revelado una verdad liberadora: el cerebro es plástico, pero también es perezoso. Para ahorrar energ├¡a, crea lo que llamamos "autopistas neuronales". Si durante años has reaccionado desde el miedo, la carencia o la complacencia, tu cerebro ha pavimentado una autopista de seis carriles hacia esa respuesta. 
                </p>
                <p>
                    Cuando te enfrentas a una decisión importante ΓÇöya sea en el amor, el dinero o el éxitoΓÇö tu mente no elige el camino más sano, sino el más transitado. Es por eso que, aunque conscientemente quieras abundancia, tu sistema nervioso puede sentirse "seguro" en la escasez, simplemente porque es lo que conoce.
                </p>
                ...
                <p>
                    Imagina por un momento cómo ser├¡a tu vida si pudieras entrar en una habitación y tomar una decisión basada en tus deseos actuales, sin el susurro del miedo heredado. Esa es la verdadera soberan├¡a biológica. Es el estado donde el cuerpo y el alma se alinean para decir "s├¡" a la vida, sin condiciones.
                </p>
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Identifica una situación que se repite constantemente en tu vida. Escr├¡bela. Ahora, pregúntate: ¿A quién de mi familia le pasó algo similar? Identifica el rostro o la historia. Al ponerle nombre, el patrón pierde su poder oculto.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Coloca una silla frente a ti e imagina que en ella está sentado el ancestro que vivió ese patrón. M├¡ralo con amor y dile internamente: <i>"Veo tu dolor, veo tu destino. Te honro dejándote tu carga a ti, y dándome el permiso de hacerlo diferente en tu honor"</i>. Observa qué pasa en tu respiración.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11 text-stone-600">Ponte de pie. Cierra los ojos y siente el peso de tus pies en la tierra. Imagina que frente a ti hay un camino nuevo, nunca antes transitado por tu linaje. Da un paso f├¡sico hacia adelante y registra la sensación de "novedad". Ese paso es tu declaración de libertad.</p>
                    </div>
                </div>
    ...
    },
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    Entender esto nos permite darnos el permiso sistémico para brillar. Cuando comprendes que tu éxito no es una traición a tus ra├¡ces, sino un regalo para todo tu linaje, el miedo se transforma en una fuerza de empuje imparable.
                </p>
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Piensa en un proyecto que te dé miedo. Cierra los ojos y localiza dónde lo sientes en el cuerpo (pecho, garganta, estómago). Pon tu mano en ese lugar y respira profundamente, dándole permiso a esa sensación de estar ah├¡ sin intentar quitarla.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Imagina a tus ancestros frente a ti. Haz una pequeña inclinación y diles: <i>"Sus destinos fueron dif├¡ciles y los honro. Ahora yo me permito tener éxito para que su esfuerzo haya valido la pena"</i>. Siente la fuerza del linaje a tus espaldas.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Pon música que te empodere. Visualiza tu meta al final de la habitación. Camina hacia ella lentamente, sintiendo que cada paso dejas atrás la necesidad de permiso externo. Al llegar, exhala fuerte un "S├ì".</p>
                    </div>
                </div>
            </div>
        `
    },
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    Vivimos en un universo de frecuencias invisibles pero tangibles. Todo lo que piensas, sientes y sostienes en tu interior emite una vibración que resuena con el mundo exterior. Tu destino no es algo estático escrito por un tercero; es un lienzo que se pinta cada d├¡a con el color de tu estado interno. Si tu energ├¡a está anclada en la queja o en deudas emocionales, el universo simplemente te devolverá más "puntos de resonancia" de ese mismo tipo.
                </p>
                ...
                <!-- EJERCICIOS -->
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    <h2 class="text-4xl font-heading text-[var(--color-primary)] border-b border-[var(--color-primary)]/20 pb-6 text-center">Cámara Alqu├¡mica</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Haz una lista de 3 personas o situaciones que te "drenen" energ├¡a. Pregúntate: ¿Qué aspecto de m├¡ resuena con esto? Al reconocer tu parte, retiras el hilo energético y recuperas tu poder personal.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Repite durante 3 minutos frente al espejo: <i>"Yo soy la fuente de mi propia abundancia. Mi frecuencia atrae bendiciones en sinton├¡a con mi propósito"</i>. Nota cómo cambia tu postura corporal al final.</p>
                    </div>
                </div>
            </div>
        `
    },
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                <!-- ATENCI├ôN -->
                <p class="text-xl font-medium text-[var(--color-primary)] italic border-l-4 border-[var(--color-secondary)] pl-6 py-2">
                    "El éxito tiene cara de madre y fuerza de padre. Si estás peleado con tus ra├¡ces, estarás peleado con tus resultados."
                </p>
                <p>
                ...
                <p>
                    Una de las reglas de oro del éxito es la <strong>humildad sistémica</strong>. Solo cuando ocupamos nuestro lugar de "hijos" frente a nuestros padres podemos ser "grandes" frente a nuestras metas. Al juzgar lo que ellos hicieron o dejaron de hacer, nos convertimos en "padres de nuestros padres", agotando nuestra energ├¡a creativa en una batalla que no podemos ganar. Tomar a los padres tal como son es abrir la fuente de la nutrición (madre) y de la estructura (padre) en nuestra carrera.
                </p>

                <!-- DESEO -->
                <h3 class="text-3xl font-heading text-[var(--color-primary)] mt-12 mb-6">La Recompensas del Orden</h3>
                <p>
                    El éxito auténtico ΓÇöese que viene acompañado de paz interna y no solo de númerosΓÇö llega cuando dejas de luchar contra tu historia. Al asentir a todo lo que fue, liberas tu energ├¡a para estar disponible para tus clientes, tus proyectos y tu prosperidad. El éxito nos sonr├¡e cuando nosotros le sonre├¡mos a nuestro origen.
                </p>
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Busca una foto de tus padres. M├¡rala sin juicios. Di en voz alta: <i>"Ustedes son los grandes, yo soy la pequeña. Gracias por la vida"</i>. Siente cómo se libera la tensión en tus hombros.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Cierra los ojos e imagina al Éxito personificado frente a ti. ¿Tiene la cara de alguien? Si es la de un padre, p├¡dele permiso para ser feliz. Si tiene tu propia cara, abraza esa versión futura de ti.</p>
                    </div>
                </div>
            </div>
        `
    },
    {
        ...
        excerpt: 'El cuerpo no miente. Cada s├¡ntoma, tensión o cansancio es un mensaje del alma tratando de ser escuchado.',
        date: '24 de Enero, 2026',
            ...
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        <h4 class="text-xl font-bold flex items-center gap-3">
                            <span class="w-8 h-8 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center text-sm">01</span>
                            Diálogo con el S├¡ntoma
                        </h4>
                        <p class="pl-11">Identifica una molestia f├¡sica actual. Cierra los ojos y visualiza que esa molestia tiene una forma o un color. Pregúntale: <i>"¿Para qué estás aqu├¡? ¿Qué quieres que vea?"</i>. Anota lo primero que te venga a la mente.</p>
                    </div>
    ...
    },
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    Lise Bourbeau identificó cinco heridas fundamentales que todos, en menor o mayor medida, cargamos: <strong>Rechazo, Abandono, Humillación, Traición e Injusticia</strong>. Para protegernos del dolor de estas heridas, nos ponemos "máscaras" (el huidizo, el dependiente, el masoquista, el controlador, el r├¡gido). El problema es que esas máscaras terminan alejándonos de nuestra verdadera esencia y del amor real.
                </p>
                <p>
    ...
    },
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    Aprender a amar con los ojos abiertos te permite construir v├¡nculos basados en la realidad y no en la proyección. Al ocupar tu lugar de "hija" frente a tus padres, dejas de pedirle a tu pareja que te rescate o que te complete. El resultado es una relación más ligera, más presente y mucho más gozosa.
                </p>

                <!-- EJERCICIOS -->
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    <h2 class="text-4xl font-heading text-[var(--color-primary)] border-b border-[var(--color-primary)]/20 pb-6 text-center">C├¡rculo de Consciéncia</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Imagina a tus ancestros detrás de ti. Mira a tu pareja y dile: <i>"Tengo a los m├¡os conmigo, tú tienes a los tuyos. Nos miramos nosotros dos"</i>. Siente cómo la relación se vuelve más presente y liviana.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Toma las manos de tu pareja (o imagina que lo haces). M├¡ralo a los ojos y di su nombre. Reconoce su singularidad, fuera de los dramas de tu árbol genealógico. Disfruta de ese instante de conexión pura.</p>
                    </div>
                </div>
            </div>
        `
    },
    {
        ...
        excerpt: 'Tu cuenta bancaria es un reflejo de tu energ├¡a vital. Analizamos los bloqueos sistémicos más comunes que impiden el flujo del dinero.',
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                <!-- ATENCI├ôN -->
                <p class="text-xl font-medium text-[var(--color-primary)] italic border-l-4 border-[var(--color-secondary)] pl-6 py-2">
                    "El dinero es una energ├¡a sistémica. En el enfoque sistémico, el dinero tiene la cara de la Madre."
                </p>
                <p>
                    Nuestra cuenta bancaria y nuestra capacidad de generar abundancia son, a menudo, un reflejo directo de nuestra relación con la vida y, espec├¡ficamente, con nuestra <strong>Madre</strong>. Ella fue nuestra primera fuente de alimento y sustento. Si hay rechazo, juicio o deuda emocional con ella, el dinero fluirá con dificultad en nuestra vida adulta. El dinero no es solo papel o números; es una energ├¡a viva que responde a nuestra capacidad de "tomar" lo que la vida nos ofrece.
                </p>
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        <h4 class="text-xl font-bold flex items-center gap-3">
                            <span class="w-8 h-8 rounded-full bg-[var(--color-primary)] text-white flex items-center justify-center text-sm">01</span>
                            Sanando el V├¡nculo con la Nutrición
                        </h4>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Toma tu billetera o tu tarjeta bancaria en tus manos. Visualiza que es un canal de luz. Di: <i>"Gracias por circular a través de m├¡. Te recibo y te entrego con amor y consciencia"</i>. Siente la paz que esto genera.</p>
                    </div>
                </div>
            </div>
        `
    },
    {
        ...
        excerpt: 'Tomar al padre es tomar la capacidad de poner l├¡mites, tener éxito en el mundo y lanzarse a lo nuevo con seguridad.',
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    En el tejido de nuestra alma, la figura del padre representa la <strong>estructura, el orden y la dirección</strong>. Es el primer "otro" que nos muestra que el mundo es un lugar vasto para ser explorado. Si sientes que te cuesta poner l├¡mites, que tus proyectos se quedan a medias o que te falta la disciplina necesaria para triunfar, es probable que necesites reconciliarte con la energ├¡a de tu padre. No importa cómo haya sido él como persona; lo que importa es la fuerza arquet├¡pica que él te entrega y que tú te permites tomar.
                </p>

                <!-- INTERÉS -->
                <h3 class="text-3xl font-heading text-[var(--color-primary)] mt-12 mb-6">El Escudo y la Espada: La Fuerza del Hacer</h3>
                <p>
                    Tomar al padre es tomar la capacidad de decir "no" cuando es necesario y "s├¡" a los desaf├¡os que nos hacen crecer. Cuando juzgamos a nuestro padre por sus ausencias o debilidades, perdemos el acceso a nuestra propia capacidad de concretar. El éxito profesional y la seguridad interna tienen la cara del padre. Al asentir a él tal como fue ΓÇöni más, ni menosΓÇö, recuperas el permiso para ser exitosa y ocupar tu lugar de autoridad en el mundo.
                </p>
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Elige una tarea pequeña que hayas estado posponiendo. Antes de empezar, respira e invoca la energ├¡a de disciplina del padre. Real├¡zala sin distracciones. Al terminar, celebra tu capacidad de concretar.</p>
                    </div>
                </div>
            </div>
        `
    },
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    En el mundo de la sanación sistémica, a menudo nos enfrentamos a barreras mentales muy fuertes: el ego, el juicio y la necesidad de entenderlo todo. Aqu├¡ es donde la <strong>Medicina del Cacao</strong> entra en juego. Al ser una planta que expande el flujo sangu├¡neo y relaja el sistema nervioso, el cacao suavemente "suaviza" nuestras defensas, permitiéndonos sentir lo que antes solo pod├¡amos pensar. Es una medicina de apertura que nos invita a habitar el presente con una vulnerabilidad valiente.
                </p>
                ...
                <p>
                    Participar en un c├¡rculo de cacao o integrar esta medicina en tu práctica personal es regalarte un momento de conexión pura con tu esencia. Al unir la sabidur├¡a sistémica con la calidez del cacao, la sanación deja de ser un proceso árido y se convierte en un viaje amoroso hacia tu propia profundidad. Es una invitación a dejar de luchar y empezar a ser.
                </p>
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Imag├¡nate sentada en un c├¡rculo con todas las mujeres de tu familia. Pásales simbólicamente esta medicina de amor. Di: <i>"Tomo el amor que viene de ustedes y lo multiplico"</i>. Siente la calidez expandirse por todo tu cuerpo.</p>
                    </div>
                </div>
            </div>
        `
    },
    {
        ...
        content: `
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <p>
                    En mi metodolog├¡a, unimos la estructura estratégica del coaching con la profundidad de la sistémica. No solo definimos objetivos, sino que exploramos si tienes "el permiso de tu alma" para lograrlos. ¿Estás intentando tener éxito para demostrarle algo a alguien? ¿O quizás estás fracasando para ser fiel a la escasez de tus abuelos? Al desatar estos nudos ancestrales, la acción externa se vuelve fluida y natural, dejando de ser un esfuerzo agotador para convertirse en una expresión de tu propósito.
                </p>
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Escribe en un papel: <i>"Lograr este objetivo no me aleja de mi familia. Mi éxito es su alegr├¡a"</i>. Pon este papel en tu lugar de trabajo como un recordatorio visual de tu propósito alineado.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Siéntate en tu silla de trabajo e imagina que eres la CEO de tu propia vida. Siente el peso de tu responsabilidad y también la libertad de elegir. Haz una llamada o env├¡a un correo que hayas estado postergando.</p>
                    </div>
                </div>
            </div>
        `
            ...
            <div class="space-y-8 text-lg leading-relaxed text-stone-700">
                ...
                <div class="bg-[var(--color-bg-alt)] p-12 rounded-[2rem] border border-[var(--color-primary)]/10 mt-16 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Haz una lista de 3 talentos que tengas (ej. comunicar, organizar, cuidar). Pregúntate: ¿Quién en mi familia ten├¡a este don pero no pudo usarlo plenamente? Pon ese talento al servicio en su honor.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Cierra los ojos e imagina que tienes a toda la humanidad frente a ti. ¿Qué grupo de personas te "duele" más o te genera más ganas de ayudar? Ah├¡ es donde tu propósito quiere expresarse.</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="pl-11">Cada mañana, antes de empezar tu d├¡a, di: <i>"Vida, úsame como un instrumento para el bien mayor. Estoy disponible en mi lugar"</i>. Observa cómo cambia la energ├¡a de tus reuniones y tareas.</p>
                    </div>
                </div>
            </div>
        `
