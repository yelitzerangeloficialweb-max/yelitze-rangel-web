...
export const EVENTS_DATA: EventData[] = [
    {
        ...
        fullDescription: [
            ...
            "Entonces, acompáñame el 10 de julio en mi próximo encuentro online gratuito Sánate Mujer.",
    ...
    },
    {
        ...
        fullDescription: [
            ...
            "- Rituales sistémicos vs Dinámicas Chamánicas.",
            ...
            "- Diferencia entre enfoques sistémicos, de trauma y Chamánicos.",
            "- Dinámicas Chamánicas en el tablero y el uso de objetos (tótems).",
