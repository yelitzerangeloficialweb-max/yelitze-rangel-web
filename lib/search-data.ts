...
const SEARCHABLE_CONTENT: SearchResult[] = [
    // BLOGS
    { id: '8', type: 'blog', title: 'Libérate de tus Patrones: La Ciencia de la Decisión', description: '¿Por qué sentimos que estamos "cableados" para el autosabotaje? Entiende cómo tu cerebro y tu sistema familiar trabajan juntos.', slug: 'liberate-de-tus-patrones', image: '/images/blog_4k/liberate_patterns.png', link: '/blog/liberate-de-tus-patrones' },
